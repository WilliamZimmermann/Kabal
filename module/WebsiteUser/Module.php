 ...
 *
 * @link      http://github.com/zendframework/WebsiteWebsiteUser for the canonical source repository
...
use WebsiteUser\Model\WebsiteUserTable;
...
class Module implements AutoloaderProviderInterface
{
    ...
    public function getServiceConfig()
    {
        return array(
            'factories' => array(
                'WebsiteUser\Model\WebsiteUserTable' => function ($sm) {
