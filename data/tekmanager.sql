...
--
-- Host: localhost:8889
-- Generation Time: Dec 23, 2016 at 09:19 PM
...
CREATE TABLE `article_category_has_language` (
...
CREATE TABLE `article_has_language` (
...
INSERT INTO `city` (`id`, `name`, `zone_id`) VALUES
(1, 'Afonso Cláudio', 8),
...
(318, 'Barreiras', 5),
(319, 'Barro Alto', 5),
(320, 'Barro Preto (antigo Gov. Loman', 5),
(321, 'Barrocas', 5),
(322, 'Belmonte', 5),
(323, 'Belo Campo', 5),
(324, 'Biritinga', 5),
...
(1484, 'Vera', 13),
(1485, 'Vila Bela da Santíssima Trinda', 13),
(1486, 'Vila Rica', 13),
(1487, 'Água Clara', 12),
(1488, 'Alcinópolis', 12),
(1489, 'Amambaí', 12),
...
(3552, 'São Francisco de Assis do Piau', 17),
...
CREATE TABLE `company_user_has_company_website` (
...
CREATE TABLE `company_website_has_language` (
...
CREATE TABLE `company_website_has_system_module` (
  `company_website_idWebsite` int(11) NOT NULL,
...
(1, 1, 1, 2, 'william.zimmer@teksul.com.br', '938dceb208db2a75fb64f6743a9c1311', '1999-01-01', 33, 'Teste\r\nOutro teste\r\nMais um teste\r\nOutro teste', '<br>Cliente alterado por meio do site pelo usuário William Zimmermann (1) em 22/12/2016 20:11:06.<br>Cliente alterado por meio do site pelo usuário William Zimmermann (1) em 22/12/2016 20:12:54.<br>Cliente alterado por meio do site pelo usuário William Zimmermann (1) em 22/12/2016 20:13:45.<br>Cliente alterado por meio do site pelo usuário William Zimmermann (1) em 22/12/2016 20:14:18.<br>Cliente alterado por meio do site pelo usuário William Zimmermann (1) em 22/12/2016 20:14:33.<br>Cliente alterado por meio do site pelo usuário William Zimmermann (1) em 22/12/2016 20:15:24.<br>Cliente alterado por meio do site pelo usuário William Zimmermann (1) em 22/12/2016 20:16:26.<br>Cliente alterado por meio do site pelo usuário William Zimmermann (1) em 22/12/2016 20:18:38.<br>Cliente alterado por meio do site pelo usuário William Zimmermann (1) em 23/12/2016 17:42:28.', '2016-12-22 18:24:23', '2016-12-23 17:42:28', 1),
(13, 1, 1, 1, 'me@williamzimmermann.com.br', '938dceb208db2a75fb64f6743a9c1311', '1993-03-31', 33, 'Teste ', 'Cliente adicionado por meio do site pelo usuário William Zimmermann (1) em 23-12-2016 18:24:13.<br>Cliente alterado por meio do site pelo usuário William Zimmermann (1) em 23/12/2016 18:28:21.<br>Cliente alterado por meio do site pelo usuário William Zimmermann (1) em 23/12/2016 18:28:33.', '2016-12-23 18:24:13', '2016-12-23 18:28:33', 1),
(14, 1, 1, 1, 'daniel.guerra@teksul.com.br', 'e10adc3949ba59abbe56e057f20f883e', '1980-01-01', 33, 'Teste', 'Cliente adicionado por meio do site pelo usuário William Zimmermann (1) em 23/12/2016 20:41:27.', '2016-12-23 20:41:27', '2016-12-23 20:41:27', 1);
...
(1, 'TekSul Informática LTDA', 'Teksul Informática', '01.171.298/0001-65', '');
...
CREATE TABLE `customer_externalsystem` (
...
(13, 'William', 'Zimmermann', '024.551.200-40', NULL),
(14, 'Daniel', 'Guerra', '965.922.140-15', NULL);
...
CREATE TABLE `system_module_has_image` (
  `system_module_idModule` int(11) NOT NULL,
...
INSERT INTO `zone` (`id`, `name`, `initials`, `country_id`) VALUES
(1, 'Acre', 'AC', 33),
(2, 'Alagoas', 'AL', 33),
(3, 'Amazonas', 'AM', 33),
(4, 'Amapá', 'AP', 33),
...
(8, 'Espírito Santo', 'ES', 33),
(9, 'Goiás', 'GO', 33),
(10, 'Maranhão', 'MA', 33),
(11, 'Minas Gerais', 'MG', 33),
(12, 'Mato Grosso do Sul', 'MS', 33),
(13, 'Mato Grosso', 'MT', 33),
(14, 'Pará', 'PA', 33),
(15, 'Paraíba', 'PB', 33),
(16, 'Pernambuco', 'PE', 33),
(17, 'Piauí', 'PI', 33),
...
(20, 'Rio Grande do Norte', 'RN', 33),
(21, 'Rondônia', 'RO', 33),
(22, 'Roraima', 'RR', 33),
(23, 'Rio Grande do Sul', 'RS', 33),
(24, 'Santa Catarina', 'SC', 33),
(25, 'Sergipe', 'SE', 33),
(26, 'São Paulo', 'SP', 33),
(27, 'Tocantins', 'TO', 33);
...
ALTER TABLE `city`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_city_zone1_idx` (`zone_id`);
...
ALTER TABLE `customer_address`
  ...
  ADD KEY `fk_customer_address_zone1_idx` (`zone_id`),
  ADD KEY `fk_customer_address_city1_idx` (`city_id`);
...
--
ALTER TABLE `customer`
  MODIFY `idCustomer` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
...
--
ALTER TABLE `city`
  ADD CONSTRAINT `fk_city_zone1` FOREIGN KEY (`zone_id`) REFERENCES `zone` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `customer_address`
  ADD CONSTRAINT `fk_customer_address_city1` FOREIGN KEY (`city_id`) REFERENCES `city` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  ADD CONSTRAINT `fk_customer_address_zone1` FOREIGN KEY (`zone_id`) REFERENCES `zone` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
